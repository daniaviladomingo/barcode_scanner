...
//                var previewHeight = 0
//
//                customParameters.supportedPreviewSizes.forEach {
//                    Log.d("ccc", "Preview: ${it.width} ${it.height}")
//                }
//
//                customParameters.supportedPictureSizes.forEach {
//                    Log.d("ccc", "Picture: ${it.width} ${it.height}")
//                }
//
